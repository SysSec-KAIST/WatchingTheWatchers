...
HOST_PCELL = EKPC_HOST
PORT_PCELL = EKPC_PORT
USERNAME_PCELL = USERNAME_EKPC
PASSWD_PCELL = PASSWD_EKPC
LOGPATH_PCELL = LOGPATH_EKPC
...
def close_all_app():
    ...
    cmd("input tap 343 2020", interval=1)
...
def toggle_airplane(interval=10):
    ...
    cmd("input tap 962 258", interval) # Go to airplane
    print('click to come back from airplane mode')
    cmd("input tap 962 258", interval) # Re attach
    cmd("input keyevent KEYCODE_HOME")

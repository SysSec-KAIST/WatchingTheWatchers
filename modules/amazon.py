...
#LOGDIR = 'KT_10Mhz_B8_720_NO_CA_NOTE5_IN'
# LOGDIR = 'SKT_10Mhz_B5_480_NO_CA_EXT1_11_NEW'
...
def main():
    ...
    for idx in range(START_IDX, START_IDX + TRIAL):
        # first clear amazon cache and setup default resolution
        # flush_amazon()
